...
export default function NoteList(props: NoteListProps) {
  return (
    <ul className={clx(props.className, 'px-2 md:pr-0 py-1 transition-all space-y-2')}>
      <li className="bg-slate-50 rounded-md border rounded-md hover:bg-blue-50">
        <button
      ...
      {props.notes.sort((a, b) => {
        ...
        return (
          <li
            className={'bg-slate-50 rounded-md border-slate-200 border group hover:bg-blue-50'}
            key={note.id}
          >
            <button
            ...
            >
              {
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center">
                    <div
                      className="py-2 pr-2 bg-slate-50 group-hover:bg-blue-50 opacity-0 group-hover:opacity-30 hover:!opacity-100 rounded-md transition-opacity"
                      onClick={(e) => {
